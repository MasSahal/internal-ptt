...
<?php if ($this->router->fetch_class() == 'reports' || $this->router->fetch_method() == 'payment_history' || $this->router->fetch_method() == 'accounts_ledger') { ?>
	<script src="<?php echo base_url(); ?>skin/hrsale_vendor/assets/vendor/datatable_export/dataTables.buttons.min.js"></script>

	<script src="<?php echo base_url(); ?>skin/hrsale_vendor/assets/vendor/datatable_export/jszip.min.js"></script>
	<script src="<?php echo base_url(); ?>skin/hrsale_vendor/assets/vendor/datatable_export/pdfmake.min.js"></script>
	<script src="<?php echo base_url(); ?>skin/hrsale_vendor/assets/vendor/datatable_export/vfs_fonts.js"></script>
	<script src="<?php echo base_url(); ?>skin/hrsale_vendor/assets/vendor/datatable_export/buttons.html5.min.js"></script>
	<script src="<?php echo base_url(); ?>skin/hrsale_vendor/assets/vendor/datatable_export/buttons.print.min.js"></script>
	<link rel="stylesheet" href="<?php echo base_url(); ?>skin/hrsale_vendor/assets/vendor/datatable_export/buttons.dataTables.min.css">
<?php } ?>
<?php if ($this->router->fetch_class() == 'settings') { ?>
	<link rel="stylesheet" href="<?php echo base_url(); ?>skin/hrsale_vendor/assets/vendor/libs/bootstrap-duallistbox/bootstrap-duallistbox.css">
	<script src="<?php echo base_url(); ?>skin/hrsale_vendor/assets/vendor/libs/bootstrap-duallistbox/bootstrap-duallistbox.js"></script>
	<script type="text/javascript">
		$(document).ready(function() {
			$('#duallistbox-example').bootstrapDualListbox({
				nonSelectedListLabel: '<?php echo $this->lang->line('xin_top_menu'); ?>',
				selectedListLabel: '<?php echo $this->lang->line('xin_moved_to_left_menu'); ?>',
...
<script type="text/javascript">
	var user_session_id = '<?php echo $session['user_id']; ?>';
</script>
<script type="text/javascript">
...
<script type="text/javascript">
	var base_url = '<?php echo site_url() . 'admin/' . $this->router->fetch_class(); ?>';
</script>
<script type="text/javascript">
	var processing_request = '<?php echo $this->lang->line('xin_processing_request'); ?>';
</script>
<script type="text/javascript">
	var request_submitted = '<?php echo $this->lang->line('xin_hr_request_submitted'); ?>';
</script>
<?php if ($this->router->fetch_class() == 'project') { ?>
	<?php if ($system[0]->show_projects == '0') { ?>
		<script type="text/javascript">
			var show_projects = 'list';
		</script>
	<?php } else { ?>
		<script type="text/javascript">
			var show_projects = 'grid';
		</script>
	<?php } ?>
<?php } ?>
