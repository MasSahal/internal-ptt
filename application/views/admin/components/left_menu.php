...
<ul class="sidenav-inner py-1">
  ...
  <?php if($system[0]->module_inquiry=='true'){?>
     ...
     <li class="sidenav-item"><a href="<?php echo site_url('admin/trainers')?>" class="sidenav-link"> <i class="fas fa-portrait sidenav-icon"></i><div><?php echo $this->lang->line('left_trainers_list');?></div></a></li>
      ...
      <li class="sidenav-item"><a href="<?php echo site_url('admin/reports')?>" class="sidenav-link"> <i class="fas fa-chart-bar sidenav-icon"></i><div><?php echo $this->lang->line('xin_hr_report_title');?></div></a></li>
      <?php } ?>
      <?php endif;?>
      <?php if(in_array('custom_fields',$hr_top_menu)):?>
      <?php  if(in_array('393',$role_resources_ids)) { ?>
      <li class="sidenav-item"><a class="sidenav-link" href="<?php echo site_url('admin/custom_fields');?>"> <i class="fas fa-sliders-h sidenav-icon"></i><div><?php echo $this->lang->line('xin_hrsale_custom_fields');?></div></a></li>
      <?php } ?>
      <?php endif;?>
