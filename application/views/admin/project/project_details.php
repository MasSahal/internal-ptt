			...
			<div class="card-body">
				<div class="card-block">
					<ul class="nav nav-tabs nav-topline">
						...
						<li class="nav-item"> <a class="nav-link list-group-item-action nav-tabs-link" href="#bugs" data-config="5" data-config-block="bugs" data-toggle="tab" aria-expanded="true" id="pj_data_5"><i class="fas fa-money-check"></i> <?php echo $this->lang->line('xin_project_cost'); ?></a> </li>
