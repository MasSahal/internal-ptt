					...
					},
					{
						...
						items: [{
							...
							},
							{
								...
								add_info: "<?php echo $this->lang->line('left_resignations'); ?>",
								value: "234",
							},
							{
								id: "",
			...
			},
			{
				...
				items: [{
					...
					},
					{
						...
						add_info: "<?php echo $this->lang->line('xin_attendance_import'); ?>",
						value: "31",
					},
					{
						id: "",
				...
				items: [{
						...
						items: [{
							...
							},
							{
								id: "",
								class: "role-checkbox custom-control-input",
								text: "<?php echo '<small>' . $this->lang->line('xin_role_view') . ' ' . $this->lang->line('left_performance_indicator') . '</small>'; ?>",
								add_info: "<?php echo $this->lang->line('xin_role_view'); ?>",
								value: "301",
							}
						]
					},
					{
						...
						items: [{
							...
							},
							{
								id: "",
								class: "role-checkbox custom-control-input",
								text: "<?php echo '<small>' . $this->lang->line('xin_role_view') . ' ' . $this->lang->line('left_performance_appraisal') . '</small>'; ?>",
								add_info: "<?php echo $this->lang->line('xin_role_view'); ?>",
								value: "305",
							}
						]
		...
		dataSource: [{
			...
			},
			{
				...
				items: [
					...
					},
					{
						...
						add_info: "<?php echo $this->lang->line('xin_system'); ?>",
						value: "118",
					},
			...
			},
			{
				...
				items: [{
					...
					{
						id: "",
						class: "role-checkbox custom-control-input-modal",
