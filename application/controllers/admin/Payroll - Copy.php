	...
	// payment history
	 ...
	 public function pdf_create(){
		...
		<table cellpadding="1" cellspacing="1" border="0">
			...
			<tr>
				<td align="center">'.$this->lang->line('xin_payroll_year_date').': '.$half_title.' <strong>'.date("F Y", strtotime($payment[0]->salary_month)).'---'.date('t',strtotime($payment[0]->salary_month.'-01')).'</strong></td>
			</tr>
		</table>
		';
		...
		$tblbrk = '<table cellpadding="3" cellspacing="0" border="1"><tr bgcolor="#69e48a">
			...
			if($payment[0]->payslip_type=='hourly'){
				...
				$total_deduction = $loan_de_amount + $statutory_deduction_amount + $add_deduct_other_payments_amount + $add_deduct_commissions_amount + $add_deduction_allowance;
				$total_net_salary = $total_earning - $total_deduction;
